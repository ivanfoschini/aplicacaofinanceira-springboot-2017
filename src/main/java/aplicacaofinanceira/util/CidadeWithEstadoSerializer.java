...
public class CidadeWithEstadoSerializer extends StdSerializer<Cidade> {

    public CidadeWithEstadoSerializer() {
        this(null);
    }

    public CidadeWithEstadoSerializer(Class<Cidade> t) {
        super(t);
    }
    ...
    public static String serializeCidadeWithEstado(Cidade cidade, Estado estado) throws JsonProcessingException {
        cidade.getEstado().setNome(estado.getNome());

        ObjectMapper mapper = new ObjectMapper();

        SimpleModule module = new SimpleModule();
        module.addSerializer(Cidade.class, new CidadeWithEstadoSerializer());
